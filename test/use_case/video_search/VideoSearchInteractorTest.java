...
class VideoSearchInteractorTest {
    ...
    @Test
    void successTestMock() throws IOException, GeneralSecurityException {
...
//                assertEquals("", video.getVideoPublishDate());
    ...
    @Test
    void successTestActual() throws IOException, GeneralSecurityException {
        ...
        FileUserDataAccessObject userRepository = new FileUserDataAccessObject("users.csv", factory);
        VideoSearchUserDataAccessInterface historyRepository = new FileHistoryDataAccessObject(userRepository);
        ...
        VideoSearchOutputBoundary presenter = new VideoSearchOutputBoundary() {
            ...
            public void prepareSuccessView(VideoSearchOutputData video) {
                ...
                assertEquals("", video.getDescription());
//                assertEquals("", video.getVideoPublishDate());
                assertEquals(13013, video.getViewCount());
                assertEquals(169, video.getLikeCount());
                assertEquals(9, video.getCommentCount());
    ...
    @Test
    void failureTestMock() throws IOException, GeneralSecurityException {
    ...
    @Test
    void failureTestActual() throws IOException, GeneralSecurityException {
        VideoSearchInputData inputData = new VideoSearchInputData("123", "user");
        VideoSearchDataAccessInterface youtubeRepository = new YouTubeDataAccess();
        UserFactory factory = new CommonUserFactory();
        FileUserDataAccessObject userRepository = new FileUserDataAccessObject("users.csv", factory);
